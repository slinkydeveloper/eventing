...
// NewCertsController constructs a controller for materializing webhook certificates.
...
func NewCertsController(
	...
	statsReporter, _ := webhook.NewStatsReporter()

	options := webhook.Options{
		Port:          port,
		SecretName:    "eventing-imc-dispatcher-certs",
	...
	c := controller.NewImpl(wh, logging.FromContext(ctx), "IMCDispatcherCertificates")
